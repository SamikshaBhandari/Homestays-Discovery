...
<html lang="en">
    ...
    <div class="reserve_form">
        <form id="Booking"action="Backend/booking.php" method="POST">
         ...
         <button class="confirm-btn" type="submit">
           <i class="fa-solid fa-check"></i> Confirm Booking</button>
              </div>
             </form>
        </div>
        <div class="booking_summary">
          ...
          <div class="total_amount">
            ...
            <div class="amount">
               <p id="total_Amount">Rs.1000</p>
            </div>
          </div>
          <div class="Secure">
            <p><i class="fa-solid fa-shield-halved"></i>Secure booking</p>
          </div>
        </div>
      </div>
    </section>
  ...
  <script src="javascriptfile/booking.js"></script>
</html>
